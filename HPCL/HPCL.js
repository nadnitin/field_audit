...
function saveData(e) {
  ...
  if (stateValue === "Delhi & Haryana SO" || stateValue === "Punjab &Himachal SO" || stateValue === "Rajasthan SO" || stateValue === "Uttar Pradesh SO-II" || stateValue === "Uttar Pradesh SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbx_sFMP9q5fBTAKNJwVxc0E4VQ_k72OkGHukQ_fOlusNmP9Q3ehPqDqJZgu-B-nEakGsQ/exec';
  }
  //WEST
  else if (stateValue === "Maharashtra SO" || stateValue === "Madhya Pradesh SO" || stateValue === "Gujarat SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbzQJVVKYhEOZNiEl76m1MX5uZVyJise6q5mX5Ot6UQ75Dnb5b9QX1sSZBLlqtawG-316Q/exec';
  }
//EAST
  else if (stateValue === "Bihar SO" || stateValue === "IndianOil-AOD St OFF" || stateValue === "West Bengal SO" || stateValue === "Odisha SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbyi1ud9QjtRsA4i-ZMNiF23V9rRZhLJl_wy8S-oxHaZZn_g11LxruAZDrJAaSDIw4M/execc';
  }
//South
  else if (stateValue === "TAPSO" || stateValue === "Kerala SO" || stateValue === "Tamilnadu SO" || stateValue === "Karnataka SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbzdAOl59HE4D4TB4bHF-JpEqZq23TzrLUgcMwfSazKjvXmTY-a-rqSIR9pt3vHmjZdvYA/exec';
  } else {
