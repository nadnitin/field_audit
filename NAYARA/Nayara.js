...
document.getElementById('imageFile').addEventListener('change', compressAndLoadAsBinary);
  ...
  function saveData(e) {
    ...
    if (stateValue === "Haryana" || stateValue === "Himachal Pradesh" || stateValue === "Punjab"  || stateValue === "Rajasthan" || stateValue === "Uttar Pradesh" || stateValue === "Uttarakhand" || stateValue === "Uttar Pradesh SO") {
      apiUrl = 'https://script.google.com/macros/s/AKfycbwtsfFaLp6qHl8y-a4ycX1nLnVJ7pxu5ucJE46anTgjHe6EVxPK5u_ytlGf5vfn8nfWPg/exec'; //North
    }
    else if (stateValue === "Maharashtra" || stateValue === "Chhattisgarh" || stateValue === "Gujarat" || stateValue === "Madhya Pradesh" || stateValue === "Diu Daman" ) {
      apiUrl = 'https://script.google.com/macros/s/AKfycbyRWA0PLhHf-qUT_P3Kv-x5a7nI2798WAztnDiIxvMawM0Y9gOsO5MKRC1KUcMyboQl/exec'; //West
    }
      ...
      apiUrl = 'https://script.google.com/macros/s/AKfycby1X5ecmRye9i5lRLJtJJELYNoUOPT4VjH_D9cW1R4smkTxtvwhbT1UV-FH4OMGypYo/exec';//East
    }
    
    else if (stateValue === "Andhra Pradesh" || stateValue === "Karnataka" || stateValue === "Kerala" || stateValue === "Tamil Nadu" || stateValue === "Telangana") {
      apiUrl = 'https://script.google.com/macros/s/AKfycbwZfHM8dqGWUny_qs21PzlKCJRXmXqzr1WSrqFEk-mXl4uyDIrIn9-sx6QGc07b2uHXmQ/exec';//South
    } else {
