...
function saveData(e) {
  ...
  if (stateValue === "Haryana" || stateValue === "Himachal Pradesh" || stateValue === "Punjab" || stateValue === "Rajasthan" || stateValue === "Uttar Pradesh" || stateValue === "Uttarakhand" || stateValue === "Uttar Pradesh SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbxT9bbIv5JYd0c9bo--pBjKsvBOyFGDKyaAL2Yu6isKi67cG98q49p75tQHrc3ryd1www/exec';
  } else if (stateValue === "Maharashtra" || stateValue === "Chhattisgarh" || stateValue === "Gujarat" || stateValue === "Madhya Pradesh" || stateValue === "Diu Daman") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbx54vWka-5fpFSCn34sNDGQw9LFWfmnfVz-8XrExYrTzAMKLyENCF7Fbu-L-VTNwxNr/exec';
    ...
    apiUrl = 'https://script.google.com/macros/s/AKfycbwPnz4tygujGX-ukrIriFy0KaQtTnuYwibSFCSLy_9PFYnqW2YbnSd5t0GcbjgVXTna/exec';
  } else if (stateValue === "Andhra Pradesh" || stateValue === "Karnataka" || stateValue === "Kerala" || stateValue === "Tamil Nadu" || stateValue === "Telangana") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbx7R25HDuC3Qp-9x93HbBy2FKjYo92y5BFqPQnXCWAvH_zOzCZOkTSld3WOjFg5YyBW_A/exec';
  } else {
