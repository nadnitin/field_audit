...
function saveData(e) {
  ...
  if (stateValue === "Delhi & Haryana SO" || stateValue === "Punjab &Himachal SO" || stateValue === "Rajasthan SO" || stateValue === "Uttar Pradesh SO -II" || stateValue === "Uttar Pradesh SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbwbvY9nk30uQ_lQF_O9R9594WK4CIv2EDwipCzkNjZWf3cm8Rh9qOigwu_yGZEr6-TwuQ/ex';//NORTH
  }
  else if (stateValue === "Maharashtra SO" || stateValue === "Madhya Pradesh SO" || stateValue === "Gujarat SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbzpi9q9rqSvqbvhmmvMZgQOduL8XtA7jOy9Wo55mpvwHeLTo8Abz3O_TTyne6Atjpkp/exec';//WEST
  }

  else if (stateValue === "Bihar SO" || stateValue === "IndianOil-AOD St OFF" || stateValue === "West Bengal SO" || stateValue === "Odisha SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbw8dkpB9yOFCUBP652KFVpVtUxpQ3jzBixAZ5OXZWC6_wSVshFQO-drAw2os3Mz4neUIw/exec';//EAST
  }

  else if (stateValue === "TAPSO" || stateValue === "Kerala SO" || stateValue === "Tamilnadu SO" || stateValue === "Karnataka SO") {
    apiUrl = 'https://script.google.com/macros/s/AKfycbzh-FuW-epZc2P_8urGLtlmHS2MQrwpdmjFNNuRr2VZDiw3z1wNj88rQTMdDTaStGLm/exec';//SOUTH
  } else {
